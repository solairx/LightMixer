...
namespace LightMixer.View
{
    ...
    public class FeaturedRgbDesigner : FeaturedRgbDesignerBase
    {
        ...
        public FeaturedRgbDesigner(RGBLedFixtureCollection fixtures)
        {
            ...
            rgbLedCollection.FixtureGroups.SelectMany(o => o.FixtureInGroup).OfType<WledFixture>().ToList().ForEach(o => o.CurrentEffectChanged += WledChanged);
        }
        ...
        public override WledEffectCategory WledEffectCategory
        {
            ...
            set
            {
                rgbLedCollection.FixtureGroups.SelectMany(o => o.FixtureInGroup).OfType<WledFixture>().ToList().ForEach(f => f.WledEffectCategory = value);
