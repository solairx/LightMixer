...
namespace LightMixer.View
{
    public class MovingHeadViewModel : MovingHeadFixtureViewModelBase
    {
        ...
        public MovingHeadViewModel(MovingHeadFixtureCollection fixtures)
        {
            ...
            movingHeadFixtureCollection.FixtureGroups.SelectMany(o => o.FixtureInGroup).OfType<MovingHeadFixture>().ToList().ForEach(o => o.CurrentEffectChanged += MovingHeadUpdated);
        ...
        public override MovingHeadFixture.Program CurrentMovingHeadProgram
        {
            ...
            set
            {
                movingHeadFixtureCollection.FixtureGroups.SelectMany(o => o.FixtureInGroup).OfType<MovingHeadFixture>().ToList().ForEach(f => f.ProgramMode = value);
        ...
        public override MovingHeadFixture.Gobo CurrentMovingHeadGobo
        {
            ...
            set
            {
                movingHeadFixtureCollection.FixtureGroups.SelectMany(o => o.FixtureInGroup).OfType<MovingHeadFixture>().ToList().ForEach(f => f.GoboPaturn = value);
        ...
        public override bool? UseAlternateColor
        {
            ...
            set
            {
                movingHeadFixtureCollection.FixtureGroups.SelectMany(o => o.FixtureInGroup).OfType<MovingHeadFixture>().ToList().ForEach(f => f.EnableAlternateColor = value == true);
        ...
        public override bool? UseDelatedPosition
        {
            ...
            set
            {
                movingHeadFixtureCollection.FixtureGroups.SelectMany(o => o.FixtureInGroup).OfType<MovingHeadFixture>().ToList().ForEach(f => f.EnableDelayedPosition = value == true);
