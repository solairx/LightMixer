    ...
    public class ManualDmxControlViewModel : BaseViewModel
    {
        ...
        public int SelectedChannel
        {
            ...
            set
            {
                ...
                ObservableCollection<DmxChannelStatus> ChannelList = LightMixerBootStrap.UnityContainer.Resolve<DmxModel>().DmxChannelStatus;
        ...
        public byte SelectedValue
        {
            ...
            set
            {
                ...
                LightMixerBootStrap.UnityContainer.Resolve<DmxModel>().DmxChannelStatus
                    .Where(
                        o => o.DmxChannelNumber == this.SelectedChannel
                        )
